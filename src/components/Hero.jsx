...
const Hero = () => {
  return (
    ...
    lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        from-primary to-[#4d8cea] bg-clip-text text-transparent'>digital</span> impact.</h1>

        <p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75
        max-w-4/5 sm:max-w-lg pb-3'>Crating meaningful connections and turning big ideas into interactive digital experiences.</p>
