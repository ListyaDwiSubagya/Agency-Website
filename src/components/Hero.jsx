...
const Hero = () => {
  return (
    ...
    lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
        ...
        xl:leading-23.75 max-w-5xl'>Turning imagination into <span className='bg-linear-to-r 
        from-primary to-[#4d8cea] bg-clip-text text-transparent'>digital</span> impact.</motion.h1>
        ...
        max-w-4/5 sm:max-w-lg pb-3'>Crating meaningful connections and turning big ideas into interactive digital experiences.</motion.p>
